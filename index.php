...
<div class="wrapper fadeInDown text-success">
  <div id="formContent">
    <!-- Tabs Titles -->

    <div class="formHeader bg-success">
        <h4 style="color:white; padding:0px; margin: 0px;">Login</h4>
    </div>

    <!-- Icon -->
    <div class="fadeIn first">
      <img src="Images/logo.jpeg" id="icon" alt="User Icon" style="width:150px;" />
    </div>
